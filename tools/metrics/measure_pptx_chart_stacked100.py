# -*- coding: utf-8 -*-
"""Chart spec oracle: open chart_stacked100.pptx in PowerPoint COM, record
chart shape geometry + per-series info, export PDF for fitz measurement."""
import sys, os, json
sys.stdout.reconfigure(encoding="utf-8")
import win32com.client

base = r"pipeline_data\pptx_probes\chart_stacked100"
pptx_path = os.path.abspath(os.path.join(base, "chart_stacked100.pptx"))
pdf_path = os.path.abspath(os.path.join(base, "chart_stacked100.pdf"))
...
with open(os.path.join(base, "chart_stacked100_truth.json"), "w", encoding="utf-8") as f:
