# -*- coding: utf-8 -*-
"""Export the shape-gradient orientation probe to PDF with PowerPoint itself.
...
Usage: python tools/metrics/export_pptx_gradrot.py
"""
...
PROBE = REPO / "pipeline_data" / "pptx_probes" / "gradrot" / "probe_gradrot.pptx"
