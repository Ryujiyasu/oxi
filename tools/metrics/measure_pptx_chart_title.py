# -*- coding: utf-8 -*-
"""Measure chart_title / chart_title2: open in PowerPoint COM, read the chart
title props (text / geometry / font), export the PDF for fitz measurement."""
import sys, os, json
