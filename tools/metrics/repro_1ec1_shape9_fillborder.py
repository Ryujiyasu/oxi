# -*- coding: utf-8 -*-
"""V_O: Test if a:solidFill + a:ln border cause 8pt shift in Shape 9."""
...
OUT_DIR = os.path.abspath("pipeline_data/1ec1_shape9_fillborder")
      ...
      <mc:Choice Requires="wps">
        <w:drawing>
          <wp:anchor distT="0" distB="0" distL="114300" distR="114300" simplePos="0"
                     relativeHeight="251670528" behindDoc="0" locked="0" layoutInCell="1" allowOverlap="1">
...
SOLID_FILL_WHITE = '<a:solidFill><a:sysClr val="window" lastClr="FFFFFF"/></a:solidFill>'
LINE_1PT = '<a:ln w="12700" cap="flat" cmpd="sng" algn="ctr"><a:solidFill><a:sysClr val="windowText" lastClr="000000"/></a:solidFill><a:prstDash val="solid"/><a:miter lim="800000"/></a:ln><a:effectLst/>'
LINE_HALF_PT = '<a:ln w="6350"><a:solidFill><a:sysClr val="windowText" lastClr="000000"/></a:solidFill></a:ln>'

VARIANTS = [
    ("V_O0_baseline_no_fill_no_line", {}),
    ("V_O1_solidFill_only", {"fill_xml": SOLID_FILL_WHITE}),
    ("V_O2_line_only", {"line_xml": LINE_1PT}),
    ("V_O3_fill_AND_line", {"fill_xml": SOLID_FILL_WHITE, "line_xml": LINE_1PT}),
    ("V_O4_line_half_pt", {"line_xml": LINE_HALF_PT}),
]
...
def main():
    ...
    print(f"Baseline V_M0 (no fill/line): advance 47.16pt → 8.16pt gap\n")
    results = []
    try:
