"""Convert default-spacing docx files to PDF via Word COM."""
import os
import sys
import glob
...
INPUT_DIR = os.path.join(SCRIPT_DIR, "docx_tests_default")
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "output", "pdfs_default")
