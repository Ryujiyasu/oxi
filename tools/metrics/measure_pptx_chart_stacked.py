# -*- coding: utf-8 -*-
"""Chart spec wave-6 oracle: open chart_stacked.pptx in PowerPoint COM, record
...
pptx_path = os.path.abspath(os.path.join(base, "chart_stacked.pptx"))
pdf_path = os.path.abspath(os.path.join(base, "chart_stacked.pdf"))
...
with open(os.path.join(base, "chart_stacked_truth.json"), "w", encoding="utf-8") as f:
