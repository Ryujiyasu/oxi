"""COM-measure Word paragraph positions for E1-E6 EMPTY repros."""
import os, json, glob
import win32com.client as win32

REPO_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
REPRO_DIR = os.path.join(REPO_ROOT, "tools", "metrics",
                         "line0_atleast_empty_repro")
OUT_PATH = os.path.join(REPO_ROOT, "tools", "metrics",
                        "line0_atleast_empty_word_measurements.json")
