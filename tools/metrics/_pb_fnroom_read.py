# -*- coding: utf-8 -*-
"""Read the fnroom probe. Usage: _pb_fnroom_read.py word|oxi
...
from _pb_fnroom_gen import ARMS, OUT
...
print("  arm          final_pg  p1notes  p2notes  p1_last_body   p1_sep   gap  rolled")
for tag, nf, nq, no in ARMS:
    ...
    print("  %-12s %5d %8d %8d %12.2f %8.2f %7.2f  %s"
          % (tag, final_pg, len(p1notes), len(p2notes), ly,
