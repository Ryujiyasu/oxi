# -*- coding: utf-8 -*-
"""Read chart_title / chart_title2 Word PDFs: dump text spans (esp. the
explicit title 'Quarterly Revenue') and vector drawings to derive the title
geometry / font / plot-area shift."""
import sys
