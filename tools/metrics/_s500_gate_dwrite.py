...
(OXI_S500_DISABLE), for a list of docs. Mirrors the ship gate (dwrite render
...
def render(dx, td, disable):
    if disable: os.environ['OXI_S500_DISABLE'] = '1'
    else: os.environ.pop('OXI_S500_DISABLE', None)
