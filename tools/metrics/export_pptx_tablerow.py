# -*- coding: utf-8 -*-
"""Export the table row-height probe to PDF with PowerPoint itself.

NEVER run this while the renderer is producing PNGs
(`pptx_com_render_must_not_overlap`).

Usage: python tools/metrics/export_pptx_tablerow.py
"""
...
PROBE = REPO / "pipeline_data" / "pptx_probes" / "tablerow" / "probe_tablerow.pptx"
