...
For each variant report: content(縺・ baseline Y, REF baseline Y, AFTER baseline Y, and
...
REPRO = os.path.join(ROOT, 'tools', 'golden-test', 'repros', 'vcenter_cellY')
...
def main():
    ...
    for a in ['30','40','50','60']:
        dx = os.path.join(REPRO, 'vcenter_%s.docx' % a)
