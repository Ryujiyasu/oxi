...
OUT_DIR = os.path.abspath(str(_REPO / r"tools\metrics\section_break_evenodd_repro"))
RESULT = os.path.abspath(str(_REPO / r"pipeline_data\section_break_evenodd.json"))
