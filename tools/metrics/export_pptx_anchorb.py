# -*- coding: utf-8 -*-
"""Export the vertical-anchor overflow probe to PDF with PowerPoint itself.
...
Usage: python tools/metrics/export_pptx_anchorb.py
"""
...
PROBE = REPO / "pipeline_data" / "pptx_probes" / "anchorb" / "probe_anchorb.pptx"
