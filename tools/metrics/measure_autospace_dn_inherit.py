...
OUT_DIR = os.path.abspath(str(_REPO / r"tools\metrics\autospace_dn_inherit_repro"))
RESULT = os.path.abspath(str(_REPO / r"pipeline_data\autospace_dn_inherit.json"))
