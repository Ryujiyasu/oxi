...
DOCS = {
    ...
    "chart_stacked100": r"pipeline_data\pptx_probes\chart_stacked100\chart_stacked100.pdf",      "chart_stacked100_dlbls": r"pipeline_data\pptx_probes\chart_stacked100_dlbls\chart_stacked100_dlbls.pdf",    "chart_title": r"pipeline_data\pptx_probes\chart_title\chart_title.pdf",
    "chart_title2": r"pipeline_data\pptx_probes\chart_title2\chart_title2.pdf",
    "chart_title_line": r"pipeline_data\pptx_probes\chart_title_line\chart_title_line.pdf",
    "chart_title_line2": r"pipeline_data\pptx_probes\chart_title_line2\chart_title_line2.pdf",
    "chart_title_pie": r"pipeline_data\pptx_probes\chart_title_pie\chart_title_pie.pdf",
    "chart_title_pie2": r"pipeline_data\pptx_probes\chart_title_pie2\chart_title_pie2.pdf",
    ...
    "chart_datalabel_line": r"pipeline_data\pptx_probes\chart_datalabel_line\chart_datalabel_line.pdf",
    "chart_datalabel_pie": r"pipeline_data\pptx_probes\chart_datalabel_pie\chart_datalabel_pie.pdf",
