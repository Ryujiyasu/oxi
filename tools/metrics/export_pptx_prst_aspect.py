...
DIR = os.path.abspath(r"pipeline_data\pptx_probes\prst_aspect")
PPTX = os.path.join(DIR, "prst_aspect.pptx")
PDF = os.path.join(DIR, "prst_aspect.pdf")
TRUTH = os.path.join(DIR, "prst_aspect_truth.json")
