...
OUT_DIR = os.path.abspath(str(_REPO / r"tools\metrics\autospace_cross_font_repro"))
RESULT = os.path.abspath(str(_REPO / r"pipeline_data\autospace_cross_font.json"))
