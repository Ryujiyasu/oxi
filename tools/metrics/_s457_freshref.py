# -*- coding: utf-8 -*-
"""Like _s457_multidoc.py but SSIMs against the FRESH word_png_new refs (S680 regen).
Usage: python _s457_freshref.py ENVVAR v1 v2 ... :: base1 base2 ..."""
...
WORD_PNG_DIR = "c:/Users/ryuji/oxi-main/pipeline_data/word_png_new"
...
print(f"REF=word_png_new (fresh)  ENV {ENVVAR}; vals {['DEFAULT']+VALS}")
