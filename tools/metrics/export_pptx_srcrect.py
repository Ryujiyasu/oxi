# -*- coding: utf-8 -*-
"""Export the srcRect / geometry picture-crop probe to PDF with PowerPoint.

NEVER run this while the renderer is producing PNGs
(`pptx_com_render_must_not_overlap`).

Usage: python tools/metrics/export_pptx_srcrect.py
"""
...
PROBE = REPO / "pipeline_data" / "pptx_probes" / "srcrect" / "probe_srcrect.pptx"
