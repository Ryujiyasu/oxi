# -*- coding: utf-8 -*-
"""Export the embedded-italic-part probe to PDF with PowerPoint itself.

NEVER run this while the renderer is producing PNGs
(`pptx_com_render_must_not_overlap`).

Usage: python tools/metrics/export_pptx_italface.py
"""
...
try:
    for probe in sorted(OUT.glob("italface_*.pptx")):
