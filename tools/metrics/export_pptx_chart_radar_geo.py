# -*- coding: utf-8 -*-
"""Export the bubble probe deck to PDF via PowerPoint COM."""
import os
import sys
...
ROOT = os.path.abspath(r"pipeline_data\pptx_probes\chart_radar_geo")
PPTX = os.path.join(ROOT, "chart_radar_geo.pptx")
PDF = os.path.join(ROOT, "chart_radar_geo.pdf")
