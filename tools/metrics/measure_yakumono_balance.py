...
VARIANTS = ["yakumono_bal_B1_balance.docx", "yakumono_bal_B2_full_compat.docx", "yakumono_bal_B3_full_and_grid.docx"]
        ...
        for pi in range(1, doc.Paragraphs.Count + 1):
            ...
            if txt.startswith("・"):
                ...
                try:
                    ...
                    print(f"[{name}] {c1.Text}x={x1:.2f} -> {c2.Text}x={x2:.2f} (adv={x2-x1:.2f}) -> {c3.Text}(adv={x3-x2:.2f})")
