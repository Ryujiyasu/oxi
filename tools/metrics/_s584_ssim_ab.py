# -*- coding: utf-8 -*-
"""S584 — SSIM sentinel for the no-type-docGrid page-bottom ink-leniency.

Render every word_png doc base with DWrite A (OXI_S584_DISABLE=1) and B
...
def render(docx, disable, outdir):
    env = dict(os.environ)
    if disable:
        env["OXI_S584_DISABLE"] = "1"
    else:
        env.pop("OXI_S584_DISABLE", None)
