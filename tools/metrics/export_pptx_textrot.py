# -*- coding: utf-8 -*-
"""Export the turned-text probe to PDF with PowerPoint itself.

NEVER run this while the renderer is producing PNGs
(`pptx_com_render_must_not_overlap`).

Usage: python tools/metrics/export_pptx_textrot.py
"""
...
PROBE = REPO / "pipeline_data" / "pptx_probes" / "textrot" / "probe_textrot.pptx"
