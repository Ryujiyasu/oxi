# -*- coding: utf-8 -*-
"""S497 gate: per-glyph (AA-free) AND dwrite SSIM, with OXI_S497_CELL_HANG ON vs OFF,
...
def measure(did,on,mode):
    if on:os.environ['OXI_S497_CELL_HANG']='1'
    else:os.environ.pop('OXI_S497_CELL_HANG',None)
    dx=docx_for(did)
