# -*- coding: utf-8 -*-
"""Spec #5b (multi-line alignment) oracle: open repro in PowerPoint COM, record
paragraph Alignment, export PDF."""
import sys, os, json
sys.stdout.reconfigure(encoding="utf-8")
import win32com.client

base = r"pipeline_data\pptx_probes\spec5b_multiline"
pptx_path = os.path.abspath(os.path.join(base, "spec5b_multiline.pptx"))
pdf_path = os.path.abspath(os.path.join(base, "spec5b_multiline.pdf"))
...
with open(os.path.join(base, "spec5b_truth.json"), "w", encoding="utf-8") as f:
